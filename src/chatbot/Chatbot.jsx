  ...
  return (
    <div>
      ...
      <div
        ...
        } min-[1380px]:hidden fixed right-4 lg:right-10 bottom-8 ${
          isMemoModalOpen ? "z-[100]" : "z-40"
        }`}
      >
        <button
          onClick={() => setIsOpen(true)}
          className="w-14 h-14 sm:w-16 sm:h-16 bg-Main text-white rounded-full shadow-lg flex items-center justify-center hover:bg-Main_hover transition-colors relative group animate-bounce-twice"
        >
          {/* 챗봇 아이콘 */}
          <svg
